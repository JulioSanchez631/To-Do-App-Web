// Type Alias para objeto de cada tarea
...
const inputFormTexto = document.getElementById("input-tarea-texto") as HTMLInputElement | null;
const formCrearTarea = document.getElementById("form-tarea-crear") as HTMLFormElement | null;
